---
title: "Tiến Độ Chương Trình Theravāda"
description: "Bảng tiến độ 36 bài và bốn tài liệu nền của domain Theravāda, gồm học phần, trạng thái nguồn, phản biện và thứ tự phát hành."
aliases: ["Theravāda Series Progress", "Lộ Trình Theravāda"]
tags: [theravada, pali, roadmap]
status: refined
related:
...
**Trạng thái ở đây phản ánh mức độ hoàn thành học thuật, không chỉ việc một tệp đã tồn tại.** Bài chỉ được đánh dấu “Đã xuất bản” sau khi nguồn, thuật ngữ, giấy phép, phản biện, hình ảnh, navigation và bản live đều qua kiểm tra.

---

## Quy Ước Trạng Thái

- **Nền đã khóa:** tài liệu Batch 0 đã được thiết kế và kiểm tra.
- **Đã có nguồn neo:** có nguồn khởi đầu, chưa hoàn tất nghiên cứu.
- **Đang nghiên cứu:** đang đọc văn bản/bản dịch.
- **Đang phản biện:** bản thảo đang kiểm tra claim và nguồn.
- **Đã xuất bản:** live và đã kiểm tra.
- **Tạm chặn:** thiếu nguồn, license hoặc còn tranh luận chưa giải quyết.

---

## Batch 0 — Tài Liệu Nền

| Tài liệu | Trạng thái |
|---|---|
| Gateway Theravāda | Nền đã khóa |
| Từ Điển Pāli Cốt Lõi | Nền đã khóa |
| Chuẩn Nguồn Và Xuất Xứ | Nền đã khóa |
| Mục Lục Kinh Dẫn | Nền đã khóa |
| Tiến Độ Chương Trình | Nền đã khóa |

---

## Học Phần I — Cửa Vào Và Bản Đồ Nguồn
...
Không đặt hạn chót cứng. Chất lượng nguồn là điều kiện chuyển batch.
