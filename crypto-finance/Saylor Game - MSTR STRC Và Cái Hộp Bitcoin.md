...
- **STRC** = sản phẩm yield để hút USD cho cái hộp đó, và USD mới có thể vừa mua BTC vừa trả dividend/runway theo disclosure rộng.
...
STRC hiện được Strategy mô tả là một preferred stock trả dividend bằng tiền mặt, rate có thể điều chỉnh, và mục tiêu là giúp nó giao dịch quanh **$100 par value**. Theo thông tin công khai từ Strategy, STRC hiện trả annual dividend khoảng **11.5%**, thanh toán semi-monthly sau khi cơ chế trả hai lần mỗi tháng được approve. Điểm mấu chốt là dividend này không đến từ BTC yield; nó là cash obligation của công ty, được trả bằng corporate cash mà public disclosures cho phép đến từ nhiều nguồn, gồm vốn raise mới.
...
3. **Vốn mới**  
   Đây là nguồn quan trọng nhất trong game: phát hành common, preferred, debt, convertible hoặc instrument mới để lấy USD. Public prospectus wording cho phép net proceeds dùng cho general corporate purposes, bao gồm mua Bitcoin, trả cash dividends trên preferred stock đang lưu hành, và working capital. Nghĩa là “new blood” không nhất thiết 100% biến thành BTC mới; một phần có thể đi vào duy trì chính capital stack.
...
Vậy STRC dưới par không giết Strategy ngay. Nhưng nó nói rằng cost of capital đã tăng, và nếu Strategy muốn tiếp tục bán preferred mới thì phải chấp nhận discount, dividend cao hơn, hoặc terms hấp dẫn hơn. Đây là lúc model chuyển từ “gọi vốn để mua BTC” sang nguy cơ “gọi vốn để duy trì claim stack”.
...
Yield này đến từ đâu? Nếu không từ business cash flow, nó đến từ vốn mới, reserve hoặc asset sale. Và nếu vốn mới vừa có thể dùng để mua BTC vừa có thể dùng để trả dividend, thì phân bổ thực tế giữa hai mục đích đó là nơi phải soi.
...
Nếu vẫn có người mua STRC ở 80 vì họ tin BTC sẽ hồi mạnh, Strategy vẫn có thể raise vốn. Nhưng vốn đó đắt hơn. Mỗi vòng issue ở giá thấp/yield cao tạo thêm claim và cash obligation trên cái hộp BTC. Càng nhiều vốn mới phải dùng để trả dividend/working capital thay vì mua BTC, quality của flywheel càng giảm.
