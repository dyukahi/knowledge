...
```mermaid
flowchart LR
    subgraph Employee[Người Làm Công]
        E1[Lương] --> E2[Thuế TNCN]
        E2 --> E3[Tiền còn lại]
        E3 --> E4[Chi tiêu]
    end
...
```mermaid
flowchart TB
    subgraph Assets[Tài Sản - Tiền VÀO]
        A1[Cổ phiếu trả cổ tức]
        A2[Bất động sản cho thuê]
