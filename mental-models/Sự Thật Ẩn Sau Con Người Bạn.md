...
```mermaid
flowchart TD
    Q["Quantum entanglement<br/>liên hệ ở cấp hạt"]
    B["Big Bang / common origin<br/>cùng nguồn vật chất"]
    S["Systems ecology<br/>liên thuộc sinh học"]
    O["Sự Nhất Thể<br/>Oneness"]
    C["Consciousness<br/>ý thức trải nghiệm"]
    M["Ma Trận<br/>ảo giác tách rời"]

    Q --> P["Pattern: reality is relational"]
    B --> P
    S --> P
    P --> O
    O --> C
...
```mermaid
flowchart LR
    A["Khoa học không linh hồn"] --> C["Technocracy"]
    B["Tâm linh không kỷ luật"] --> D["Delusion"]
    E["Khoa học + nội tâm + đạo đức"] --> F["Trí tuệ sống"]
```
