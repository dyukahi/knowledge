...
```mermaid
flowchart TD
    A[Tứ Linh] --> L[Long<br/>Thiên khí / Power / Long mạch]
    A --> QL[Lân<br/>Đức hạnh / Minh quân / Harmony]
    A --> Q[Quy<br/>Ký ức / Trường thọ / Nền móng]
    A --> P[Phụng<br/>Tái sinh / Lửa / Sacred feminine]
    L --> C[Trật tự trời-đất]
    QL --> C
    Q --> C
    P --> C
```
