...
```mermaid
flowchart TD
    A["Thiếu nội lực<br/>fear / greed / desperation"]
    B["Cầu xin bên ngoài<br/>spirit, shrine, charm, guru"]
    C["Nhận kết quả nhanh<br/>luck, romance, money, influence"]
    D["Ràng buộc vô hình<br/>debt, obsession, dependency"]
    E["Mất sovereignty<br/>phải quay lại xin tiếp"]
