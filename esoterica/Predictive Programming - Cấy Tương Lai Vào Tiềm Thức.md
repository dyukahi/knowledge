...
```mermaid
flowchart TD
    S["Seed<br/>đưa concept vào fiction"]
    R["Repeat<br/>lặp qua phim, game, news, meme"]
    F["Frame<br/>gắn với hero, fear, romance, inevitability"]
    N["Normalize<br/>không còn lạ"]
    I["Implement<br/>policy / market / tech"]
    A["Accept<br/>'giống phim đó mà'"]
    S --> R --> F --> N --> I --> A
```
