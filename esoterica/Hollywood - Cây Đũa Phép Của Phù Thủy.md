...
aliases: ["Hollywood - Cây Đũa Phép Của Phù Thủy"]
...
flowchart TD
    N["NASA / space myth"]
    D["Disney / childhood myth"]
    H["Hollywood / adult myth"]
    A["Algorithm / distribution"]
    P["Public imagination"]
    N --> P
    D --> P
    H --> P
    A --> P
