...
```mermaid
flowchart TD
    subgraph "Mạng lưới Darwin"
        E[Erasmus Darwin<br/>Freemason, đề xuất tiến hóa]
...
```mermaid
flowchart TD
    D[Phát hiện bộ xương khổng lồ<br/>Báo chí địa phương đưa tin]
    S[Smithsonian "thu thập"<br/>để "nghiên cứu"]
    V[Bộ xương biến mất<br/>Không bao giờ trưng bày]
    E[Narrative "không có bằng chứng"<br/>về giants được duy trì]
