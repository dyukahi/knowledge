...
```mermaid
graph TD
    A[Atlantis<br/>~50,000 BCE] --> B[First Destruction<br/>Split into 5 Islands]
    B --> C[Second Destruction<br/>~28,000 BCE]
    C --> D[Final Cataclysm<br/>~10,500 BCE]
    D --> E[Survivors Flee]
    E --> F[Egypt<br/>Pyramids]
...
```mermaid
graph TD
    A[Bermuda Triangle Phenomena] --> B[Compass Malfunction]
...
graph LR
    subgraph Atlantis
        A1[Crystal Tech] --> A2[Weaponization]
