...
## I. CẤU TRÚC VŨ TRỤ: Trứng Vũ Trụ & Ba Tầng Thế Giới

Trước khi nói về lịch sử, cần hiểu **không gian** nơi lịch sử xảy ra.

Theo [[Bức Tường Băng|Ice Wall Manifesto]], vũ trụ không phải vô tận như khoa học hiện đại mô tả. Thay vào đó, toàn bộ tạo hóa nằm trong một **Trứng Vũ Trụ (Cosmic Egg)** — với cấu trúc ba tầng xếp chồng:

```
┌─────────────────────────────────────────────┐
│              TRỨNG VŨ TRỤ                   │
│  ┌───────────────────────────────────────┐  │
│  │         AKUPARA (tầng cao nhất)       │  │
│  │  ┌─────────────────────────────────┐  │  │
│  │  │       ATLAS (tầng giữa)         │  │  │
│  │  │  ┌───────────────────────────┐  │  │  │
│  │  │  │    EARTH (tầng thấp)      │  │  │  │
...
│  └───────────────────────────────────────┘  │
│                                             │
│       [Bên ngoài: Vùng Rác vô tận]          │
└─────────────────────────────────────────────┘
```

Nếu mô hình này đúng, **Bức Tường Băng (Antarctica)** không chỉ là rìa của Trái Đất mà là **ranh giới** giữa tầng Earth và những vùng đất khác. Điều này giải thích tại sao Antarctic Treaty (1959) cấm khám phá tự do — không phải vì "bảo vệ môi trường" mà vì **có gì đó cần giấu**.
