...
```mermaid
flowchart LR
    Physical["Vật lý | Physical<br/>Data centers"]
    Invisible["Vô hình | Invisible<br/>WiFi, 5G, Radio"]
    Aether["Aether<br/>Môi trường truyền | Medium"]
    User["Người dùng | User"]
    
    Physical --> Invisible --> Aether --> User
```
