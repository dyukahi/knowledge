...
```mermaid
timeline
    title Nuclear Physics Timeline / Lịch Sử Vật Lý Hạt Nhân
    1896 : Becquerel "phát hiện" radioactivity
         : Becquerel "discovers" radioactivity
    1898 : Curie phát hiện Radium, Polonium
         : Curie discovers Radium, Polonium
    1905 : Einstein công bố E=mc² (CHƯA CHỨNG MINH)
         : Einstein publishes E=mc² (UNPROVEN)
    1911 : Rutherford đề xuất nuclear model
         : Rutherford proposes nuclear model
    1927 : Muller claim X-rays gây mutation
         : Muller claims X-rays cause mutations
    1938 : Hahn Meitner phát hiện fission
         : Hahn Meitner discover fission
    1942 : Fermi Chicago Pile-1
         : Fermi Chicago Pile-1
    1945 : Trinity + Hiroshima
         : Trinity + Hiroshima
    1946 : Muller nhận Nobel (GIẤU BẰNG CHỨNG)
         : Muller receives Nobel (HIDING EVIDENCE)
```
...
```mermaid
flowchart TD
    R[Rockefeller Foundation] --> B[Niels Bohr Institute]
...
```mermaid
mindmap
  root((Nuclear Narrative))
    Energy
      Reactors work - confirmed
      Cheap energy suppressed
      Benefits Oil/Gas
    Weapons
      Exaggerated power?
      DEW alternative?
    ...
    Funding
      ...
      Same families both sides
      Narrative manufactured
```
