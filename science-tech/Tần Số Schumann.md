...
```mermaid
flowchart LR
    A[Earth Rhythm<br/>sun, soil, Schumann, seasons] --> B[Nervous System Regulation]
    C[Artificial Rhythm<br/>screens, EMF, notifications] --> D[Dysregulation / Overstimulation]
    B --> E[Grounded Attention]
    D --> F[Anxiety / Sleep Disruption]
```
