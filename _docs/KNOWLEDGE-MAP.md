...
### Mental Models / Mô hình tư duy `mental-models` — 43 notes

- [[mental-models/index|Mental Models Domain Gateway]] — degree `62`, backlinks `6`, outlinks `56` — #domain-gateway, #epistemology, #mental-model
...
- … 31 more notes in this domain. See JSON for full list.
...
- [[crypto-finance/Giữ Tiền Quan Trọng Hơn Kiếm Tiền|Giữ Tiền Quan Trọng Hơn Kiếm Tiền]] — degree `31`, backlinks `21`, outlinks `10` — #crypto-finance, #dopamine, #financial-sovereignty, #mental-model, #risk-management
...
- [[index|Red Pill Wiki]] — degree `164`, backlinks `7`, outlinks `157` — #index, #navigation
...
1. [[index|Red Pill Wiki]] — degree `164` · backlinks `7` · outlinks `157`
...
5. [[mental-models/index|Mental Models Domain Gateway]] — degree `62` · backlinks `6` · outlinks `56`
...
- `#mental-model` — 31 notes: [[crypto-finance/Giữ Tiền Quan Trọng Hơn Kiếm Tiền|Giữ Tiền Quan Trọng Hơn Kiếm Tiền]]; [[esoterica/Mental Model - Kiến Trúc Bẻ Khóa Ma Trận|Mental Model - Kiến Trúc Bẻ Khóa Ma Trận]]; [[health/Mental Model - Chiến Lược Phòng Thủ Và Tái Sinh Trong Ma Trận|Mental Model - Chiến Lược Phòng Thủ Và Tái Sinh Trong Ma Trận]]; [[mental-models/Abilene Paradox - Nghịch Lý Đồng Thuận Giả|Abilene Paradox - Nghịch Lý Đồng Thuận Giả]]; [[mental-models/Buông Bỏ Chén Thánh - Wabi-sabi, Kintsugi Và Sự Bình Yên Trong Trading|Buông Bỏ Chén Thánh - Wabi-sabi, Kintsugi Và Sự Bình Yên Trong Trading]]
